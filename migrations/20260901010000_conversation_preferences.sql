...
ALTER TABLE room_memberships ADD COLUMN muted_until TEXT;
ALTER TABLE room_memberships ADD COLUMN preferences_updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP;
